error id: jar:file://<HOME>/.cache/coursier/v1/https/repo.akka.io/maven/com/typesafe/akka/akka-actor_2.13/2.10.6/akka-actor_2.13-2.10.6-sources.jar!/akka/actor/ActorCell.scala:
jar:file://<HOME>/.cache/coursier/v1/https/repo.akka.io/maven/com/typesafe/akka/akka-actor_2.13/2.10.6/akka-actor_2.13-2.10.6-sources.jar!/akka/actor/ActorCell.scala
...
offset: 7634
uri: jar:file://<HOME>/.cache/coursier/v1/https/repo.akka.io/maven/com/typesafe/akka/akka-actor_2.13/2.10.6/akka-actor_2.13-2.10.6-sources.jar!/akka/actor/ActorCell.scala
text:
```scala
/*
...
trait ActorContext extends ActorRefFactory with ClassicActorContextProvider {
   ...
   *
   * This method is thread-safe and can be c@@alled from other threads than the ordinary
   * actor message processing thread, such as [[java.util.concurrent.CompletionStage]] and [[scala.concurrent.Future]] callbacks.
   */
